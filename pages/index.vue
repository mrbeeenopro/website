  ...
  <div class="mb-4 grid grid-cols-4 gap-4">
    ...
    <div class="col-span-3">
      <p>
        ...
        and I'm
        <AgeCounter
          :birthTimestamp="1015961400000"
          :width="107"
          :height="18"
          fontSize="16"
          textColor="#9399b2"
        />
        years old. Welcome to my little website from internet i make ramdom small project 
        <span class="text-overlay0">(and sometimes hardware)</span> for the most
        random projects.
      </p>
      <p>
        <code class="text-overlay2"> ¯⁠\⁠_⁠(⁠ツ⁠)⁠_⁠/⁠¯ </code>
        <code class="text-overlay0"> :3 </code>
        <code class="text-surface1"> :]] </code>
      </p>
    </div>
  </div>
